Here there are some links of NERFs repos and comments:

*Tip: You can "git submodule add https://github.com/..." for adding repositories inside your repository to keep everything updated authomatically.*

# Visual NeRFs 

[UTM repository](https://ice.eurecat.org/gitlab/multimedia/ai4heritage)

### Baselines 

[Vanilla NeRFs](https://github.com/bmild/nerf)
<br />
[Mip NeRF](https://github.com/google/mipnerf)
...
<br />
[DietNet (Few-shot)](https://ajayj.com/dietnerf/)
<br />
[LightGaussian (Optimized Gaussian Splatting)](https://lightgaussian.github.io/)

### Wide range (fore- and background) 

[Mip-Nerf 360](https://jonbarron.info/mipnerf360/)
<br />
[Zip-Nerf (Mip-Nerf 360 + iNGP)](https://jonbarron.info/zipnerf/)
 

### In the wild (occlusions + appearance) 

[NeRF-W (unconstrained)](https://nerf-w.github.io)
<br />
[Ha-NeRF (hallucinated)](https://github.com/rover-xingyu/Ha-NeRF)
<br />
[NeRFactor (shape+reflectance unkown illum.)](https://dl.acm.org/doi/pdf/10.1145/3478513.3480496)
 

### Other input sources 

[Point-Nerf](https://xharlie.github.io/projects/project_sites/pointnerf/index.html)
<br />
[Depth Nerf](https://www.cs.cmu.edu/~dsnerf/)
<br />
[GANerf](https://arxiv.org/pdf/2306.06044.pdf)

## More (Videos, CLIP, Diffusion...)

[Nerfplayer](https://docs.nerf.studio/en/latest/nerfology/methods/nerfplayer.html) for generating videos
<br />
[Generfacto](https://docs.nerf.studio/en/latest/nerfology/methods/generfacto.html) for generating 3D scenes from text
<br />
[Nerf2Nerf](https://docs.nerf.studio/en/latest/nerfology/methods/in2n.html) for editing 3D from text
<br />
[LERF](https://docs.nerf.studio/en/latest/nerfology/methods/lerf.html) for 3D clipping using text queries

### Materials / Reflections

[Ref-Nerf](https://dorverbin.github.io/refnerf/)
<br />
[NeRFREN](https://github.com/bennyguo/nerfren)
<br />
[NeX](https://nex-mpi.github.io)
<br />
[GET3D](https://nv-tlabs.github.io/GET3D/)
<br />
[Neural rendering](https://research.nvidia.com/labs/rtr/neural_appearance_models/)
<br />
[ENVIDR](https://nexuslrf.github.io/ENVIDR/)
<br />
[VolSDF](https://lioryariv.github.io/volsdf/)
<br />
[NVDIFFREC](https://nvlabs.github.io/nvdiffrec/)

### Alternative implementations 

Various NeRFs and benchmarking: https://github.com/openxrlab/xrnerf 
<br />
...
[NerfMeshing](https://arxiv.org/abs/2303.09431)
<br />
[GET3D](https://nv-tlabs.github.io/GET3D/)
...
MESH2IR (related) https://github.com/anton-jeran/MESH2IR 
 

### Classic techniques to separate reflectance from illumination. 

[Coherent Intrinsic Images from Photo Collections](https://inria.hal.science/hal-00761123/document)
<br />
[The Visual Turing Test for Scene Reconstruction](https://grail.cs.washington.edu/projects/sq_rome_g1/paper.pdf) 
...
<br />
[TurboNeRF](https://github.com/JamesPerlman/TurboNeRF)
...
<br />
https://www.youtube.com/watch?v=mw43A8Y6Nlg 


## DATASETS 

Various well-known NeRF datasets https://github.com/kakaobrain/NeRF-Factory 
<br />
<br />
...
<br />
https://arxiv.org/abs/2303.02091 
<br />
http://www.songho.ca/opengl/gl_transform.html 


### NeRF-Text: fur, grass or fabric textures neural representation. 

https://developer.nvidia.com/blog/nvidia-research-nerf-tex-neural-reflectance-field-textures/ 
<br />
Recommended reading Reflectance Transformation Imaging (RTI) 
<br />
https://www.conservation-wiki.com/wiki/Reflectance_Transformation_Imaging_(RTI)#What_is_RTI 

 

### Shadows 

https://grail.cs.washington.edu/projects/sq_rome_g1/paper.pdf

### Classic approaches to 3D scene reconstruction

https://inria.hal.science/hal-00761123/document 
<br />
https://www.academia.edu/download/32749047/3dv-2013.pdf 
<br />
Combination of LiDAR (point cloud) + NeRFs 
...
* Normal Consistency  
* HAUSDORFF distance 
* Compare to SoTA photogrammetry: software like Phototourism? COLMAP? 

### Occupancy regularization 

LOLNeRFs (https://openaccess.thecvf.com/content/CVPR2022/papers/Rebain_LOLNerf_Learn_From_One_Look_CVPR_2022_paper.pdf) -> EQ 8
<br />
also explained in https://www.youtube.com/live/nRCOsBHt97E?feature=share&t=632 
<br />
...
* [ACOUSTIC NeRFs (paper) ](https://openreview.net/forum?id=lkQ7meEa-qv )
* [Check out implementation](https://github.com/aluo-x/Learning_Neural_Acoustic_Fields)
* [Novel-View Acoustic Synthesis (NVAS)](https://arxiv.org/pdf/2301.08730.pdf)
<br />
[LIBROSA-PyTorch class converter:](https://ice.eurecat.org/gitlab/multimedia/deeparts/-/blob/avgan/code/AVGAN/converter.py)
...
<br />
https://arxiv.org/pdf/2206.08312.pdf 
<br />
* Auxiliary libraries like LIBROSA https://librosa.org/ 
 

### PHYSICS INFORMED, some notes:

* Early reflections + late reverberation.
* Parameters (phase, sample rate, window length, instant frequency, spectrogram magnitude)
[One-dimensional sound field predictions](https://arxiv.org/pdf/2109.11313.pdf)

### MCRoomSim 

https://github.com/Andronicus1000/MCRoomSim 

* Define a list of geometrical and material parameters to experiment with 
* Define some rules (grid) to move receiver and emitter locations. 
* Define a range of values for those parameters. 
* Parameters and ranges should be perceptually relevant 
* Define input, storage, and output formats. 
OUTCOME: precise list of instructions for a developer on how to generate a dataset under those conditions. 
 

### IR Interpolation 

* Paper: [Source position interpolation of spatial room impulse responses](https://www.aes.org/e-lib/browse.cfm?elib=22044)
* [Room impulse response interpolation using a sparse spatio-temporal representation of the sound field](https://ftp.esat.kuleuven.be/pub/SISTA//nantonel/17-26.pdf) 
* [Room Impulse Response Interpolation via Optimal Transport](https://aaltodoc.aalto.fi/server/api/core/bitstreams/d2b588f8-d4e9-4171-b281-ce72c6ad7547/content)
...
arXiv 2023. [[PDF](http://arxiv.org/abs/2304.14401)] [[Project](https://jitengmu.github.io/ActorsNeRF/)]
...
arXiv 2023. [[PDF](http://arxiv.org/abs/2304.06706)] [[Project](https://jonbarron.info/zipnerf/)]
...
arXiv 2023. [[PDF](http://arxiv.org/abs/2304.06714)] [[Project](https://lakonik.github.io/ssdnerf)]
