...
"""
Implementation of vanilla nerf + hallucidated (anti-occlusion mask + appearance encoding).
"""
...
from nerfstudio.field_components.hallucidated import E_attr, implicit_mask #PosEmbedding

'''
To do: revise functions and update this file
...
@dataclass
class HaNerfModelConfig(ModelConfig):
    """Ha-Nerf Model Config"""
...
class HaNeRFModel(Model):
    """Ha-NeRF model

    Args:
        config: Ha-NeRF configuration to instantiate model
    """

    config: HaNerfModelConfig
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_mask = True
        self.encode_a = True
        self.N_a = 48 # number of embeddings for appearance
        self.N_vocab = 100 # number of vocabulary (images) for defining embedding_view

        self.field_appearance = None # updated later
        self.field_mask = None # updated later
        ####################
    ...
    def populate_modules(self):
        ...
        '''
        apparance_encoding = E_attr(input_dim_a=3, output_nc=self.N_a)
        mask_embedding = implicit_mask() # use

        self.field_appearance = HaNeRFField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
            apparance_encoding=apparance_encoding,
        )

        self.field_mask = HaNeRFField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
    ...
    def get_param_groups(self) -> Dict[str, List[Parameter]]:
        '''
        To do: include keys for field_appearance and field_mask
        '''
        param_groups = {}
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        '''
        To do: include forward of field_appearance and field_mask
        '''
    ...
    def get_image_metrics_and_images(
        ...
        '''
        To do: include output keys for field_appearance and field_mask
        '''
